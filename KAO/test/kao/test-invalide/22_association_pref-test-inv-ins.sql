/*
-- =========================================================================== A
 -- tester des insertions invalides pour la table association_intol en utilisant inserer_pref_alimentaire
-- -----------------------------------------------------------------------------
...
--
set schema 'kaotest';
-- tester des insertions invalides pour la table association_intol en utilisant les procédures
-- inserer_pref_alimentaire
-- l'invocation de la table association_intol pour insertion est  aussi verifiée a partir de ces procedure
...
-- insertion valide dans la table association_intol
insert into association_intol(type,enregistrement)
    values (1,1);
-- essais de faire une attribution de intolerence a un enregistrement qui a deja été faite
insert into association_intol(type,enregistrement)
    values (1,1);
--==========================================================================>Professionnel
...
-- Test avec un d'insertion invalide dans la table association_intol
-- pour un professionnel en utilisant la procedurec creer_enregistrement_professionnel
-- l'invocation de la table association_intol pour insertion est  aussi verifiée
...
--==================================================================================================>Responsable
-- Test avec un d'insertion invalide dans la table association_intol pour un responsable
...
-- association_intol pour un bénévole
...
insert into association_intol(type,enregistrement)
    values (4,4);
--==========================================================================>bénévole
-- Test avec un d'insertion invalide dans la table association_intol pour un bénévole en utilisant la procedurec creer_enregistrement_benevole
-- l'invocation de la table association_intol pour insertion est  aussi verifiée
...
values (5, 'Bénévole');
insert into type_intol(idintol, nom)
    values  (5, 'Mollusques et crustacés');
